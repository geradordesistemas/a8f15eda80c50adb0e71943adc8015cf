...
./run.sh bin/console security:create-admin AlanGuedes alanguedes00@live.com a8f15eda80c50adb0e71943adc8015cf

# Cria usuário padrão
./run.sh bin/console security:create-user AlanGuedes alanguedes00@live.com a8f15eda80c50adb0e71943adc8015cf
